...
def main(verbose=1):
    ...
    if sys.argv[1] != 'test':
        ...
        for ix_feat in range(17):
            ...
            clf = ExtraTreesClassifier(n_estimators=1000, bootstrap=True, n_jobs=28)
        ...
        with open("../data/planet_amazon/extratrees_preds%d.npy"%(fold_id), "wb") as iOF:
            np.save(iOF, y_pred)
        with open("../data/planet_amazon/extratrees_trues%d.npy"%(fold_id), "wb") as iOF:
            np.save(iOF, y_val)
