...
#==============================================
_EPSILON = K.epsilon()
from train_model_inceptionv3_128 import fbs, binary_crossentropy_weighted, preprocess_input
...
def load_model(chosen_metrics=[fbs],
               inception_json="inceptionv3_128_mod.json",
               inception_h5="inceptionv3_128_fine_tuned_2.h5", verbose=1):
    """
...
def main(verbose=1):
    ...
    if sys.argv[2] != 'test':
        ...
        with open("../data/planet_amazon/inceptionv3_128_preds%d_%d.npy"%(fold_id,n_inference), "wb") as iOF:
            np.save(iOF, y_pred)
        with open("../data/planet_amazon/inceptionv3_128_trues%d_%d.npy"%(fold_id,n_inference), "wb") as iOF:
            np.save(iOF, y_test)
        ...
        with open("../data/planet_amazon/inceptionv3_128_predstest_%d.npy"%n_inference, "wb") as iOF:
            np.save(iOF, y_pred_folds)
        with open("../data/planet_amazon/inceptionv3_128_idstest_%d.txt"%n_inference, "w") as iOF:
