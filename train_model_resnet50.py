...
def finetune_from_saved(resnet_h5_load_from, resnet_h5_save_to,
             ...
             resnet_h5_check_point="resnet50_fine_tuned_check_point_2.h5", verbose=1):
    """
...
def train_for_a_fold(df_train, df_val, fold_id, target_size=(256,256),
    ...
    base_model, model = instantiate(n_classes, n_dense=1024, resnet_json=model_dir+"resnet50_mod_%d.json"%fold_id, verbose=verbose)
    ...
    finetune(base_model, model, X_train, y_train, X_val, y_val, batch_size=24, epochs_1=5,
             ...
             resnet_h5_check_point_1=model_dir+"resnet50_fine_tuned_check_point_1_%d.h5"%fold_id,
